...
namespace SupplierHub.Repositories.Interface
{
	public interface IUserRepository
	{
		...
		// Added: fetch user by email including user-role and role navigation
		Task<User?> GetByEmailWithRolesAsync(string email, bool includeDeleted = false, CancellationToken ct = default);
	}
}